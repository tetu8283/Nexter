...
<div class="sidebar" id="sidebar">
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link text-white" href="{{ route('arrivals.create') }}">入荷予定登録</a></li>
        @if (Auth::user()->role == 1)
            <li class="nav-item">
        ...
        @else
            <li class="nav-item">
                <a class="nav-link text-white" href="#" data-bs-toggle="modal" data-bs-target="#inventoryRegisterModal">在庫登録</a></li>
        @endif
    </ul>
</div>
