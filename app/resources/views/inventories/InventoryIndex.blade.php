        ...
        <div class="col-md-4">
            <div class="card bg-light mb-3">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-1">従業員数</h5>
                        <p id="employeesNum" class="card-text fs-3 text-end text-primary mb-0">{{ $employeesNum }} 人</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-light mb-3">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-1">在庫数</h5>
                        <p id="inventoriesNum" class="card-text fs-3 text-end text-success mb-0">{{ $inventoriesNum }} 冊</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-light mb-3">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-1">総重量</h5>
                        <p id="totalBooksWeight" class="card-text fs-3 text-end text-warning mb-0">{{ $totalBooksWeight }} Kg</p>
                    </div>
                </div>
            </div>
        </div>
